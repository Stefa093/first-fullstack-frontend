export default function Login() {
  return (
    ...
    <div className="flex h-screen w-full">    
      <div className=" h-28 w-320 mx-auto my-auto shadow-2xl rounded-lg grid grid-cols-2">
        <div className=" bg-login-img bg-no-repeat rounded-l-lg h-28 w-160" ></div>
        <div className="h-28 w-160  flex flex-col">
